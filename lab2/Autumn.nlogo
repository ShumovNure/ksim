...
let time-of-day round current-hour / day-hour * 24  ;; Створив локальну змінну для розбиття доби на промежутки та щоб оперувати не глобальною змінною
